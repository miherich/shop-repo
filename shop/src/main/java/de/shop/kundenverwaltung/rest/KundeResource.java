...
public class KundeResource {
	...
	private URI getUriBestellungen(Kunde kunde, UriInfo uriInfo) {
		return uriHelper.getUri(KundeResource.class, "findBestellungenByKundeId", kunde.getKundennr(), uriInfo);
	}		
	...
	public Link[] getTransitionalLinks(Kunde kunde, UriInfo uriInfo) {
		...
		final Link remove = Link.fromUri(uriHelper.getUri(KundeResource.class, "deleteKunde", kunde.getKundennr(), uriInfo))
                                .rel(REMOVE_LINK)
                                .build();
	...
	public URI getUriKunde(Kunde kunde, UriInfo uriInfo) {
		return uriHelper.getUri(KundeResource.class, "findKundeById", kunde.getKundennr(), uriInfo);
	}
